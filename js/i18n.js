...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      rag_active_tip_title: 'Recomendación para consultas:',
      rag_active_tip_desc: 'Para consultas y extracción de datos, usa una <strong>temperatura baja (0 a 0,2)</strong> en el chat: reduce la dispersión en las búsquedas y asegura respuestas más consistentes y directas.',
    ...
    en: {
      ...
      rag_active_tip_title: 'Tip for queries:',
      rag_active_tip_desc: 'For queries and data extraction, use a <strong>low temperature (0 to 0.2)</strong> in chat settings: it reduces search variance and ensures more direct, consistent answers.',
