...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      tool_search_title: 'Buscador Web: search_web',
      tool_search_query: '🔍 Búsqueda Solicitada por el Modelo:',
      tool_search_results: '📄 Resultados Obtenidos ({count} fuentes):',
      tool_search_empty: 'No se encontraron resultados directos para esta búsqueda.',
      ...
      agent_search_title: '🔍 Búsqueda en Internet en Tiempo Real',
      agent_search_desc: 'Permite al modelo invocar search_web para buscar información actualizada, noticias, enlaces y artículos en internet mediante APIs abiertas sin bloqueos.',
    ...
    en: {
      ...
      tool_search_title: 'Web Search: search_web',
      tool_search_query: '🔍 Search Requested by Model:',
      tool_search_results: '📄 Retrieved Results ({count} sources):',
      tool_search_empty: 'No search results found for this query.',
      ...
      agent_search_title: '🔍 Real-time Web Search',
      agent_search_desc: 'Allows the model to call search_web to search for up-to-date information, news, links, and articles on the internet using open non-blocking APIs.',
