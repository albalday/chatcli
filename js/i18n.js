/**
 * Módulo de Internacionalización y Multi-idioma (ChatI18n) para ChatCLI v2.0.
...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      app_title: 'ChatCLI v2.0 - Cliente Web Universal de Chat para IA',
    ...
    en: {
      // Metadata & Headers
      app_title: 'ChatCLI v2.0 - Universal AI Chat Web Client',
