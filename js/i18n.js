/**
 * Módulo de Internacionalización y Multi-idioma (ChatI18n) para ZeroChat v5.5.1.
...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      app_title: 'ZeroChat v5.5.1 - Cliente Web Universal de Chat & Agente IA',
      ...
      rag_delete_branch: '🗑️ Eliminar',
      rag_export_branch: '⬇️ Respaldo',
      rag_import_branch: '⬆️ Restaurar',
    ...
    en: {
      // Metadata & Headers
      app_title: 'ZeroChat v5.5.1 - Universal AI Chat & Agent Web Client',
      ...
      rag_delete_branch: '🗑️ Delete',
      rag_export_branch: '⬇️ Backup',
      rag_import_branch: '⬆️ Restore',
